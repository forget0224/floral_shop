...
if ($totalRows > 0) {
    ...
    $sql .= " ORDER BY store_id LIMIT :offset, :limit";
    // 使用參數化查詢
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <form class="d-flex align-items-center" method="get" action="">
                            ...
                            <div class="form-group mx-1">
                                <label for="filterSubscription">訂閱方式：</label>
                                <select id="filterSubscription" name="filterSubscription">
                                    <option value="">請選擇</option>
                                    <option value="1個月" <?= isset($_GET['filterSubscription']) && $_GET['filterSubscription'] === '方式1' ? 'selected' : '' ?>>1個月</option>
                                    <option value="6個月" <?= isset($_GET['filterSubscription']) && $_GET['filterSubscription'] === '方式1' ? 'selected' : '' ?>>6個月</option>
                                    <option value="12個月" <?= isset($_GET['filterSubscription']) && $_GET['filterSubscription'] === '方式2' ? 'selected' : '' ?>>12個月</option>
                                </select>
                            </div>
